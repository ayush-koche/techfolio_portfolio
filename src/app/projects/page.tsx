...
import { FaGithub, FaExternalLinkAlt, FaSalesforce } from "react-icons/fa"; // Salesforce icon added
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <motion.div
                className="flex flex-wrap gap-4 mt-auto pt-2"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.4 }}
              >
                {/* 1. Salesforce Link Logic */}
                {project.trailheadLink && project.trailheadLink !== "" && (
                  <motion.a
